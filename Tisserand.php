...
<body id="inner_page" data-spy="scroll" data-target="#navbar-wd" data-offset="98">
        ...
        <div class="container" style="padding-top: 60px;">
            <div class="row">
                <div class="col-md-12">
                    ...
                    Devenez Tisserand Expert : Maîtrisez l'Art du Tissage Traditionnel et Moderne</p>
                </div>
                <div class="col-md-12 text-justify ">
                    <p style="font-size:1rem " ;>Cette formation intensive vous permettra d'acquérir des compétences solides et diversifiées pour devenir un tisserand polyvalent et qualifié. Vous apprendrez à maîtriser les techniques de tissage, à concevoir des motifs complexes et à travailler avec différents types de fibres pour créer des tissus de qualité. Grâce à une approche pratique et intensive, vous serez prêt à répondre aux besoins d'un marché de la mode et du design textile en constante évolution.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section style="padding: 50px;">
        ...
        <div class="centered-columns">
            <div>
                <p><i class="fas fa-chevron-right"></i> Comprendre les différentes techniques de tissage, y compris le tissage manuel et mécanique.</p>
                <p><i class="fas fa-chevron-right"></i> Créer des motifs et des dessins complexes pour des textiles uniques..</p>
                <p><i class="fas fa-chevron-right"></i> Sélectionner et préparer les fibres et les fils adaptés à chaque projet de tissage.</p>
                <p><i class="fas fa-chevron-right"></i> Utiliser des métiers à tisser traditionnels et modernes pour produire des tissus de haute qualité.</p>


            </div>
            <div>
            <p><i class="fas fa-chevron-right"></i>  Gérer le processus de tissage, de la préparation des fils à la finition des tissus.
                <p>
                <p><i class="fas fa-chevron-right"></i> Intégrer des techniques de teinture et de finition pour améliorer la qualité et l'esthétique du tissu. <p>
                <p><i class="fas fa-chevron-right"></i> Travailler de manière efficace en atelier et collaborer avec des designers textiles et des créateurs de mode.</p>
                <p><i class="fas fa-chevron-right"></i>  Présenter et vendre vos créations lors d'expositions et de marchés..<p>
                    ...
                    <div id="collapse1" class="collapse" aria-labelledby="heading1" data-parent="#accordion">
                        <div class="card-body">
                            ...
                            <ul>
                                ...
                                <li><i class="fas fa-chevron-right"></i>
                                Artiste en textile </li> <br>

                                <li><i class="fas fa-chevron-right"></i>
                                Technicien(ne) en tissage
                                </li> <br>
                                <li><i class="fas fa-chevron-right"></i>
                                Artisan créateur(trice) de tissus
                                </li> <br>
                ...
                <div class="card">
                    ...
                    <div id="collapse2" class="collapse" aria-labelledby="heading2" data-parent="#accordion">
                        <div class="card-body">
                            ...
                            <ul>
                                <li><i class="fas fa-chevron-right"></i>
                                Un intérêt pour les arts manuels et le design textile.</li> <br>
                ...
                <div class="card">
                    ...
                    <div id="collapse3" class="collapse" aria-labelledby="heading3" data-parent="#accordion">
                        <div class="card-body">
                            ...
                            <ul>
                                <li><i class="fas fa-chevron-right"></i>
                                Des contrôles continus (quiz, exercices pratiques de tissage).</li> <br>

                                <li><i class="fas fa-chevron-right"></i>
                                Des projets individuels et en équipe.</li> <br>

                                <li><i class="fas fa-chevron-right"></i>
                                Un projet final qui sera présenté et défendu devant un jury composé de professionnels du secteur.</li> <br>
                    ...
                    <div id="collapse5" class="collapse" aria-labelledby="heading5" data-parent="#accordion">
                        <div class="card-body">
                            ...
                            <ul>
                                ...
                                <li><i class="fas fa-chevron-right"></i>
                                    <span style="font-weight: 600;">
                                    Challenges et concours de couture 
