...
<body id="inner_page" data-spy="scroll" data-target="#navbar-wd" data-offset="98">
    ...
    <section class="inner_banner">
        ...
        <div class="container">
            <div class="full animate__animated animate__fadeInDown">
                <h3> Entrepreunariat Agricole</h3>
            </div>
        </div>
    </section>
    <!--section-->
        ...
        <div class="container" style="padding-top: 60px;">
            <div class="row">
                <div class="col-md-12">
                    ...
                    Devenez Entrepreneur Agricole : Construisez des Entreprises Durables et Innovantes</p>
                </div>
                <div class="col-md-12 text-justify ">
                    <p style="font-size:1rem " ;>Transformez votre passion pour l'agriculture en une entreprise prospère et respectueuse de l'environnement. Cette formation vous guide à travers les étapes essentielles de la création et de la gestion d'une entreprise agricole, en combinant théorie et pratique pour vous préparer à un avenir entrepreneurial réussi dans le secteur agricole.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section style="padding: 50px;">
        ...
        <div class="centered-columns">
            <div>
                <p><i class="fas fa-chevron-right"></i> Élaborer un business plan solide pour un projet agricole.</p>
                <p><i class="fas fa-chevron-right"></i> Identifier et exploiter les opportunités de marché dans le secteur agricole.</p>
                <p><i class="fas fa-chevron-right"></i> Mettre en œuvre des techniques agricoles innovantes et durables.</p>
            ...
            <div>
                ...
                <p>
                <p><i class="fas fa-chevron-right"></i> Appliquer les technologies numériques et les outils informatiques pour une gestion efficace      <p>
                    ...
                    <div id="collapse1" class="collapse" aria-labelledby="heading1" data-parent="#accordion">
                        <div class="card-body">
                            <ul>
                                ...
                                <li><i class="fas fa-chevron-right"></i>
                                Gestionnaire d’exploitation agricole </li> <br>

                                <li><i class="fas fa-chevron-right"></i>
                                Spécialiste en agriculture durable et responsable
                                </li> <br>
                ...
                <div class="card">
                    ...
                    <div id="collapse2" class="collapse" aria-labelledby="heading2" data-parent="#accordion">
                        <div class="card-body">
                            ...
                            <ul>
                                <li><i class="fas fa-chevron-right"></i>
                                Intérêt pour le secteur agricole et l'entrepreneuriat.</li> <br>

                                <li><i class="fas fa-chevron-right"></i>   
                                Compétences de base en gestion et en analyse.
                            </li> <br>
                            <li><i class="fas fa-chevron-right"></i>   
                            Une motivation à apprendre et à innover dans un domaine en constante évolution.
                            </li> <br>
                ...
                <div class="card">
                    ...
                    <div id="collapse3" class="collapse" aria-labelledby="heading3" data-parent="#accordion">
                        <div class="card-body">
                            ...
                            <ul>
                                <li><i class="fas fa-chevron-right"></i>
                                Des tests de connaissances et des évaluations pratiques régulières.</li> <br>

                                <li><i class="fas fa-chevron-right"></i>
                                Des études de cas et des présentations individuelles.</li> <br>

                                <li><i class="fas fa-chevron-right"></i>
                                Un projet de fin de formation présenté et défendu devant un jury</li> <br>
                        ...
                        <div class="card-body">
                            ...
                            <ul>
                                ...
                                <li><i class="fas fa-chevron-right"></i>
                                    ...
                                    </span> :Participez à des sessions intensives en personne avec des experts du secteur.</li> <br>

                                <li><i class="fas fa-chevron-right"></i>
                                    <span style="font-weight: 600;">
                                    Mentorat individuel
                                    </span> : Recevez des conseils pratiques d'un mentor qui vous aidera à structurer votre projet et à surmonter les obstacles.</li>
                                <br>
                                <li><i class="fas fa-chevron-right"></i>
                                    <span style="font-weight: 600;">
                                    Travaux de groupe et projets collaboratifs
                                    </span> : Travaillez avec d'autres participants pour échanger des idées et développer des solutions innovantes.</li>
                                <br>
                                <li><i class="fas fa-chevron-right"></i>
                                    <span style="font-weight: 600;">
                                    Séminaires et conférences
                                    </span> :  Assistez à des événements animés par des leaders du secteur pour élargir vos connaissances et votre réseau.</li>
                                <br>
                                <li><i class="fas fa-chevron-right"></i>
                                    <span style="font-weight: 600;">
                                    Mises en situation et simulations 
                                    </span> :  Appliquez vos compétences en participant à des simulations réalistes de gestion agricole</li>
                                <br>
