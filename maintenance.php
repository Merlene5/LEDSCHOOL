...
<body id="inner_page" data-spy="scroll" data-target="#navbar-wd" data-offset="98">
    ...
    <section class="inner_banner">
        ...
        <div class="container">
            <div class="full animate__animated animate__fadeInDown">
                <h3>Maintenance Informatique et Gsm</h3>
            </div>
        </div>
    </section>
    <!--section-->
            ...
            <div class="row">
                <div class="col-md-12">
                    <p style="font-size: 2rem; font-weight: 600;line-height: 1.6; text-align: center">
                        Formation Maintenance Informatique et GSM : Devenez un expert en réparation et entretien de
                        systèmes électroniques</p>
                </div>
                <div class="col-md-12 text-justify ">
                    <p style="font-size:1rem " ;>Cette formation complète vous apprendra à diagnostiquer, réparer et
                        entretenir des équipements informatiques et mobiles. En combinant théorie et pratique, vous
                        développerez les compétences nécessaires pour intervenir sur des ordinateurs, des smartphones,
                        des tablettes et d'autres équipements électroniques. Grâce à un apprentissage approfondi, vous
                        serez prêt à répondre aux besoins du marché en constante évolution.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section style="padding: 50px;">
        ...
        <div class="centered-columns">
            <div>
                <p><i class="fas fa-chevron-right"></i> Diagnostiquer les pannes matérielles et logicielles sur des
                    ordinateurs et des appareils mobiles.</p>

                <p><i class="fas fa-chevron-right"></i> Réparer des composants électroniques, comme les cartes mères,
                    les écrans, et les batteries.</p>
                <p><i class="fas fa-chevron-right"></i> Installer et configurer des systèmes d'exploitation, des
                    logiciels, et des applications mobiles.</p>
                <p><i class="fas fa-chevron-right"></i> Effectuer des maintenances préventives et correctives.</p>
            </div>
            <div>


                <p><i class="fas fa-chevron-right"></i> Gérer des données sensibles (sauvegarde, récupération de
                    données, etc.).
                <p>
                <p><i class="fas fa-chevron-right"></i> Conseiller les clients sur l'achat et l'utilisation de leurs
                    équipements
                <p>
                <p><i class="fas fa-chevron-right"></i> Suivre les évolutions technologiques et adapter vos compétences
    ...
    <section style="padding: 50px;">
        ...
        <div class="columns">
            ...
            <div>
                ...
                <ul>
                    <li class="list-item"><i class="fa fa-check-circle li-icon"></i> Bases du matériel informatique et
                        des réseaux.</li>
                    <li class="list-item"><i class="fa fa-check-circle li-icon"></i> Introduction aux systèmes
                        d'exploitation (Windows, Linux, Android, iOS).</li>
                </ul>
                ...
                <ul>
                    ...
                    <li class="list-item"><i class="fa fa-check-circle li-icon"></i> Remplacement et assemblage de
                        composants.</li>
                    <li class="list-item"><i class="fa fa-check-circle li-icon"></i> Gestion des pannes logicielles
                        (virus, corruption de données).</li>
                ...
                <ul>
                    ...
                    <li class="list-item"><i class="fa fa-check-circle li-icon"></i> Remplacement des écrans, batteries,
                        connecteurs, et autres pièces.</li>
                    <li class="list-item"><i class="fa fa-check-circle li-icon"></i> Réinitialisation et déverrouillage
                        des appareils..</li>
            ...
            <ul>
                ...
                <li class="list-item"><i class="fa fa-check-circle li-icon"></i> Réparation d'équipements récents
            ...
            <ul>
                ...
                <li class="list-item"><i class="fa fa-check-circle li-icon"></i> Réalisation d’un projet final basé
                    sur un problème concret.</li>
            </ul>
            </p>
                    ...
                    <div id="collapse1" class="collapse" aria-labelledby="heading1" data-parent="#accordion">
                        <div class="card-body">
                            ...
                            <ul>
                                ...
                                <li><i class="fas fa-chevron-right"></i>
                                    Réparateur d’appareils GSM (smartphones et tablettes)
                                </li> <br>

                                <li><i class="fas fa-chevron-right"></i>
                                    Consultant en réparation et configuration de systèmes</li> <br>

                                <li><i class="fas fa-chevron-right"></i>
                                    Responsable d’atelier de maintenance</li> <br>
                ...
                <div class="card">
                    ...
                    <div id="collapse2" class="collapse" aria-labelledby="heading2" data-parent="#accordion">
                        <div class="card-body">
                            <ul>
                                <li><i class="fas fa-chevron-right"></i>
                                    Connaissance de base en informatique (utilisation d'un ordinateur)</li> <br>

                                <li><i class="fas fa-chevron-right"></i>
                                    Intérêt pour les technologies numériques et électroniques.</li> <br>

                                <li><i class="fas fa-chevron-right"></i>
                                    Aptitude manuelle pour manipuler des composants technique </li> <br>
                                    <li><i class="fas fa-chevron-right"></i>
                                     Motivation et curiosité pour l'apprentissage pratique. </li> <br>
                    ...
                    <div id="collapse3" class="collapse" aria-labelledby="heading3" data-parent="#accordion">
                        <div class="card-body">
                            ...
                            <ul>
                                ...
                                <li><i class="fas fa-chevron-right"></i>
                                    Un projet final incluant la rédaction de contenus complets, à présenter devant un
                                    jury.</li> <br>
                ...
                <div class="card">
                    ...
                    <div id="collapse5" class="collapse" aria-labelledby="heading5" data-parent="#accordion">
                        <div class="card-body">
                            ...
                            <ul>
                                <li><i class="fas fa-chevron-right"></i>
                                    <span style="font-weight: 600;"> Cours interactifs et démonstrations</span> :Accédez à des supports multimédias pour comprendre les principes théoriques.
                                </li> <br>
                                ...
                                <li><i class="fas fa-chevron-right"></i>
                                    ...
                                    </span> : Bénéficiez de l’accompagnement d’experts en maintenance informatique et GSM.
                                </li> <br>

                                <li><i class="fas fa-chevron-right"></i>
                                    <span style="font-weight: 600;">
                                        Projets en conditions réelles 
                                    </span> : Réalisez des travaux pour résoudre des problèmes concrets sur des appareils défectueux.
                                </li>
                                <br>
                                ...
                                <li><i class="fas fa-chevron-right"></i>
                                    <span style="font-weight: 600;">
                                        Feedback régulier  :
                                    </span> : Recevez des critiques constructives pour progresser dans vos compétences
                                </li>
                                <br>
                            </ul>
