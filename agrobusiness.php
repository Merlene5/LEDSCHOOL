...
<body id="inner_page" data-spy="scroll" data-target="#navbar-wd" data-offset="98">
            ...
            <div class="row">
                <div class="col-md-12">
                    <p style="font-size: 2rem; font-weight: 600;line-height: 1.6; text-align: center">
                        Devenez Agro Entrepreneur : Maîtrisez la Gestion de l'Entreprise Agricole et la Stratégie de Développement</p>
                </div>
                <div class="col-md-12 text-justify ">
                    <p style="font-size:1rem " ;>Grâce à cette formation,vous apprendrez à créer et gérer des projets innovants dans le domaine de l'agro business, en valorisant les ressources agricoles, promouvant les produits 
                        agricoles et développant des activités agricoles attractives.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section style="padding: 50px;">
        ...
        <div class="centered-columns">
            <div>
                <p><i class="fas fa-chevron-right"></i> Comprendre les principes fondamentaux de l'agro business.</p>
                <p><i class="fas fa-chevron-right"></i> Développer des compétences en gestion et en management d'entreprise agricole </p>
                <p><i class="fas fa-chevron-right"></i> Apprendre à créer et à mettre en œuvre des stratégies de marketing et de vente pour les produits agricoles</p>
              

            </div>
            <div>
                <p><i class="fas fa-chevron-right"></i> Maîtriser les techniques de production et de transformation des produits agricoles</p>

                <p><i class="fas fa-chevron-right"></i> Comprendre les enjeux de la durabilité et de la responsabilité environnementale dans l'agro business
                </p>
            </div>
        </div>
    </section>
    ...
    <section style="padding: 50px;">
        ...
        <p> D'une masse totale horaire de <span class="section-info"> 500 heures</span>, le programme est structuré
        ...
        <div>
            ...
            <ul>
                ...
                <li class="list-item"><i class="fa fa-check-circle li-icon"></i> Comprendre les techniques de négociation et de vente</li>
                    ...
                    <div id="collapse1" class="collapse" aria-labelledby="heading1" data-parent="#accordion">
                        <div class="card-body">
                            ...
                            <ul>
                                ...
                                <li><i class="fas fa-chevron-right"></i>
                                    Gestionnaire de production agricole
                                </li> <br>

                                <li><i class="fas fa-chevron-right"></i>
                                    Responsable de marketing et de vente pour les produits agricoles</li> <br>

                                <li><i class="fas fa-chevron-right"></i>
                                    Consultant en agro business
                                </li> <br>
                                <li><i class="fas fa-chevron-right"></i>
                                    Responsable de la durabilité et de la responsabilité environnementale
                                </li> <br>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div id="collapse2" class="collapse" aria-labelledby="heading2" data-parent="#accordion">
                        <div class="card-body">
                            ...
                            <ul>
                                ...
                                <li><i class="fas fa-chevron-right"></i>
                                    Intérêt pour l'agro business et la gestion d'entreprise agricole
                                </li> <br>
                                <li><i class="fas fa-chevron-right"></i>
