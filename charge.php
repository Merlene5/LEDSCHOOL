    ...
    <section class="inner_banner">
        ...
        <div class="container">
            <div class="full animate__animated animate__fadeInDown">
                <h3> Chargé de communication et de marketing digital</h3>
            </div>
        </div>
    </section>
    <!--section-->
    <section>
        <div class="container" style="padding-top: 60px;">
            <div class="row">
                <div class="col-md-12">
                    ...
                    Devenez Chargé de Communication et de Marketing Digital : Maîtrisez les Stratégies de Communication Moderne</p>
                </div>
                <div class="col-md-12 text-justify ">
                    <p  style="font-size:1rem ";>Cette formation intensive est conçue pour vous préparer à devenir un professionnel expert en communication et marketing digital. Vous apprendrez à développer et gérer des stratégies de communication numérique, à concevoir des campagnes de marketing digital efficaces et à utiliser des outils analytiques pour optimiser vos actions. À la fin de la formation, vous serez prêt à répondre aux défis d'un environnement digital en constante évolution et à contribuer de manière significative au succès de votre entreprise.</p></div>
     ...
     <section style="padding: 50px;">
        ...
        <div class="centered-columns">
            <div>
                <p><i class="fas fa-chevron-right"></i> 	Élaborer des stratégies de communication digitale adaptées aux objectifs de l'entreprise.</p>
                <p><i class="fas fa-chevron-right"></i>  Concevoir et gérer des campagnes de marketing digital sur différents canaux (emailing, réseaux sociaux, SEO/SEM, etc.).</p>
                <p><i class="fas fa-chevron-right"></i> Utiliser les principaux outils de marketing numérique (Google Analytics, SEMrush, Hootsuite, etc.) pour optimiser vos campagnes.</p>
                <p><i class="fas fa-chevron-right"></i> Créer des contenus pertinents et engageants pour le web et les réseaux sociaux</p>
                <p><i class="fas fa-chevron-right"></i> Analyser et interpréter des données pour prendre des décisions basées sur des indicateurs de performance clés.<p>
               </div>
            <div>
               
                <p><i class="fas fa-chevron-right"></i>	   Gérer la réputation de marque et la communication de crise sur les plateformes numériques. </p>                
                <p><i class="fas fa-chevron-right"></i>    Appliquer les meilleures pratiques en matière de conception web et de user experience (UX)</p>
                <p><i class="fas fa-chevron-right"></i>     Développer des campagnes de publicité payante (PPC) sur Google Ads et les réseaux sociaux.</p>
               <p><i class="fas fa-chevron-right"></i>	    Collaborer efficacement avec les équipes de création, développement et stratégie.</p>
            </div>
        </div>
    </section>
                    ...
                    <div id="collapse1" class="collapse" aria-labelledby="heading1" data-parent="#accordion">
                        <div class="card-body">
                            <ul>
                                ...
                                <li><i class="fas fa-chevron-right"></i>
                                Community manager</li> <br>

                                <li><i class="fas fa-chevron-right"></i>
                                Spécialiste en stratégie de contenu </li> <br>
                                 <li><i class="fas fa-chevron-right"></i>
                                 Consultant en marketing numérique </li> <br>
                    ...
                    <div id="collapse2" class="collapse" aria-labelledby="heading2" data-parent="#accordion">
                        <div class="card-body">
                            ...
                            <ul>
                                ...
                                <li><i class="fas fa-chevron-right"></i>
                                Intérêt pour le domaine de la communication et du marketing.</li> <br>

                                <li><i class="fas fa-chevron-right"></i>
                                Motivation et désir d'apprendre..</li> <br>
                ...
                <div class="card">
                    ...
                    <div id="collapse5" class="collapse" aria-labelledby="heading5" data-parent="#accordion">
                        <div class="card-body">
                            ...
                            <ul>
                                <li><i class="fas fa-chevron-right"></i>
                                    <span style="font-weight: 600;"> Cours en ligne interactifs</span> :Accès à notre plateforme d'e-learning avec vidéos, quiz et exercices.                                </li> <br>

                                <li><i class="fas fa-chevron-right"></i>
                                    <span style="font-weight: 600;">
                                    	Ateliers pratiques en présentiels
                                    </span>  :Séances avec des experts pour des échanges et des mises en situation.                                </li> <br>

                                <li><i class="fas fa-chevron-right"></i>
                                    <span style="font-weight: 600;">
                                    Mentorat personnalisé 
                                    </span> :  Accompagnement individuel pour des conseils adaptés. </li> <br>

                                <li><i class="fas fa-chevron-right"></i>
                                    <span style="font-weight: 600;">
                                    Challenges et hackathons
                                    </span> :  Mettez en pratique vos connaissances lors de simulations réalistes.  </li>
                                <br>

                                <li><i class="fas fa-chevron-right"></i>
                                    <span style="font-weight: 600;">
                                    Mini-soutenances 
                                    </span> : Évaluations régulières pour recevoir des retours constructifs   </li> <br>
