...
<body id="inner_page" data-spy="scroll" data-target="#navbar-wd" data-offset="98">
            ...
            <div class="row">
                <div class="col-md-12">
                    <p style="font-size: 2rem; font-weight: 600;line-height: 1.6; text-align: center">
                     Devenez Maître du Reportage Audiovisuel: maîtrisez l’art de capturer, de raconter et de partager des histoires à travers la photographie et la vidéo.</p>
                </div>
                <div class="col-md-12 text-justify ">
                    <p style="font-size:1rem " ;>Grâce à cette formation  immersive ,vous apprendrez à capturer l’actualité avec impact et créativité. Destinée aux passionnés de journalisme visuel et d’investigation, elle vous permettra de maîtriser les techniques de reportage vidéo et photo pour documenter des événements et raconter des histoires percutantes.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section style="padding: 50px;">
        ...
        <div class="centered-columns">
            <div>
                <p><i class="fas fa-chevron-right"></i> Réaliser des reportages vidéo et photo de qualité professionnelle</p>
                <p><i class="fas fa-chevron-right"></i> Utiliser des équipements audiovisuels (caméras, drones, micros, etc.) de manière optimale</p>
                <p><i class="fas fa-chevron-right"></i> Maîtriser les bases de la narration visuelle pour structurer vos reportages</p>
               </div>
            <div>

                <p><i class="fas fa-chevron-right"></i> Effectuer des montages vidéo dynamiques en intégrant des éléments multimédias</p>
                <p><i class="fas fa-chevron-right"></i> Travailler efficacement sur le terrain en conditions réelles.
                <p>
                <p><i class="fas fa-chevron-right"></i> Publier et promouvoir vos reportages sur différentes plateformes digitales.
                <p>
            </div>
        </div>
    </section>
                    ...
                    <div id="collapse1" class="collapse" aria-labelledby="heading1" data-parent="#accordion">
                        <div class="card-body">
                            <ul>
                                ...
                                <li><i class="fas fa-chevron-right"></i>
                                Documentariste</li> <br>

                                <li><i class="fas fa-chevron-right"></i>
                                Correspondant de presse audiovisuelle </li> <br>

                               <li><i class="fas fa-chevron-right"></i>
                               Réalisateur de contenu multimédia </li> <br>
                ...
                <div class="card">
                    ...
                    <div id="collapse2" class="collapse" aria-labelledby="heading2" data-parent="#accordion">
                        <div class="card-body">
                            ...
                            <ul>
                                <li><i class="fas fa-chevron-right"></i>
                                Avoir une passion pour l’image et la narration</li> <br>

                                <li><i class="fas fa-chevron-right"></i>
                                Maîtrise de base des outils informatiques</li> <br>
                                 <li><i class="fas fa-chevron-right"></i>
                                    Être curieux et créatif </li> <br>
                ...
                <div class="card">
                    ...
                    <div id="collapse3" class="collapse" aria-labelledby="heading3" data-parent="#accordion">
                        <div class="card-body">
                            ...
                            <ul>
                                <li><i class="fas fa-chevron-right"></i>
                                    Des quiz , exercices pratiques et mini-projets.</li> <br>

                                <li><i class="fas fa-chevron-right"></i>
                                Réalisation de reportages en groupe pour développer vos compétences en équipe.</li> <br>

                                <li><i class="fas fa-chevron-right"></i>
                                   Réalisation d’un reportage complet, de l’écriture du script à la diffusion. Ce projet sera présenté et défendu devant un jury de professionnels</li> <br>
                                   <li><i class="fas fa-chevron-right"></i>
                                   Évaluations orales et écrites pour vous aider à améliorer vos productions audiovisuelles</li> <br>
                ...
                <div class="card">
                    ...
                    <div id="collapse5" class="collapse" aria-labelledby="heading5" data-parent="#accordion">
                        <div class="card-body">
                            ...
                            <ul>
                                <li><i class="fas fa-chevron-right"></i>
                                    <span style="font-weight: 600;">Cours interactifs </span> :Ateliers interactifs avec mise en situation réelle</li> <br>

                                <li><i class="fas fa-chevron-right"></i>
                                    <span style="font-weight: 600;">
                                    Projets collaboratifs
                                    </span> : Travail en équipe pour des productions de qualité.  </li> <br>

                                <li><i class="fas fa-chevron-right"></i>
                                    <span style="font-weight: 600;">
                                    Challenges terrain
                                    </span> : Reportages sur des événements locaux ou régionaux.</li>
                                <br>
                                <li><i class="fas fa-chevron-right"></i>
                                    <span style="font-weight: 600;">
                                    Accès aux équipements professionnels
                                    </span> : Caméras, drones, logiciels de montage, etc.</li>
                                <br>
                            </ul>
