...
<body id="inner_page" data-spy="scroll" data-target="#navbar-wd" data-offset="98">
        ...
        <div class="container" style="padding-top: 60px;">
            <div class="row">
                ...
                <div class="col-md-12 text-justify ">
                    <p style="font-size:1rem " ;>Cette formation vous prépare à devenir un superviseur de zone efficace, capable de gérer et de coordonner les activités de votre équipe dans une zone géographique spécifique.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section style="padding: 50px;">
        ...
        <div class="centered-columns">
            <div>
                <p><i class="fas fa-chevron-right"></i> Comprendre les principes fondamentaux de la supervision de zone</p>
                <p><i class="fas fa-chevron-right"></i> Développer des compétences en gestion et en management de zone </p>
                <p><i class="fas fa-chevron-right"></i> Apprendre  à créer des stratégies de gestion efficaces </p>
            ...
            <div>
                ...
                <p><i class="fas fa-chevron-right"></i> Sécurité et santé au travail dans une zone géographique spécifique</p>
            </div>
        </div>
    </section>
