...
<body id="inner_page" data-spy="scroll" data-target="#navbar-wd" data-offset="98">
        ...
        <div class="container" style="padding-top: 60px;">
            <div class="row">
                <div class="col-md-12">
                    ...
                    Devenez Cordonnier Expert : Maîtrisez l'Art de la Réparation et de la Création de Chaussures et d'Accessoires en Cuir</p>
                </div>
                <div class="col-md-12 text-justify ">
                    <p style="font-size:1rem " ;>Cette formation intensive vous permettra d'acquérir des compétences solides pour devenir cordonnier professionnel, capable de réparer, restaurer et créer des chaussures et accessoires en cuir de haute qualité. Vous apprendrez les techniques traditionnelles et modernes, les méthodes de finition et de personnalisation, ainsi que les aspects liés à la gestion d'un atelier de cordonnerie.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section style="padding: 50px;">
        ...
        <div class="centered-columns">
            <div>
                <p><i class="fas fa-chevron-right"></i>Réparer et restaurer des chaussures et des accessoires en cuir, en utilisant les techniques appropriées.</p>
                <p><i class="fas fa-chevron-right"></i> Créer des chaussures sur mesure et des accessoires en cuir, en respectant des normes esthétiques et fonctionnelles.</p>
                <p><i class="fas fa-chevron-right"></i> Utiliser des outils et des machines spécifiques à la cordonnerie de manière sécurisée et efficace.</p>
                <p><i class="fas fa-chevron-right"></i>Choisir les matériaux et les produits de qualité pour garantir la durabilité des créations.</p>


            </div>
            <div>
            <p><i class="fas fa-chevron-right"></i>  Appliquer des techniques de finition avancées pour améliorer l'apparence et la résistance des articles.
             <p>
            <p><i class="fas fa-chevron-right"></i> Comprendre les aspects de la gestion d'un atelier, y compris la relation avec les clients et la gestion des stocks. <p>
            <p><i class="fas fa-chevron-right"></i> Développer des compétences en personnalisation de chaussures et en design de motifs.</p>
                    ...
                    <div id="collapse1" class="collapse" aria-labelledby="heading1" data-parent="#accordion">
                        <div class="card-body">
                            <ul>
                                ...
                                Cordonier/cordonnière
                                </li> <br>

                                <li><i class="fas fa-chevron-right"></i>
                                     
                                Réparateur d'articles en cuir
                                </li> <br>

                                <li><i class="fas fa-chevron-right"></i>
                                Créateur de chaussures et accessoires sur mesure </li> <br>

                                <li><i class="fas fa-chevron-right"></i>
                                Technicien en entretien et restauration de cuir
                                </li> <br>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="card">
                    ...
                    <div id="collapse2" class="collapse" aria-labelledby="heading2" data-parent="#accordion">
                        <div class="card-body">
                            ...
                            <ul>
                                <li><i class="fas fa-chevron-right"></i>
                                Un intérêt pour le travail manuel</li> <br>
                    ...
                    <div id="collapse3" class="collapse" aria-labelledby="heading3" data-parent="#accordion">
                        <div class="card-body">
                            ...
                            <ul>
                                ...
                                <li><i class="fas fa-chevron-right"></i>
                                Un projet final qui sera présenté et défendu devant un jury 
                                composé de professionnels du secteur.</li> <br>
                        ...
                        <div class="card-body">
                            ...
                            <ul>
                                ...
                                <li><i class="fas fa-chevron-right"></i>
                                    ...
                                    </span> : Participez à des sessions en atelier pour pratiquer le tissage avec des experts et poser des questions sur vos projets</li> <br>
                                ...
                                <li><i class="fas fa-chevron-right"></i>
                                    <span style="font-weight: 600;">
                                    Challenges de cordonnerie  
                                    </span>: Participez à des concours de réparation et de création pour enrichir votre portfolio.</li>
                                <br>
                                <li><i class="fas fa-chevron-right"></i>
                                    <span style="font-weight: 600;">
                    ...
                    <div id="collapse7" class="collapse" aria-labelledby="heading7" data-parent="#accordion">
                        <div class="card-body">
                            ...
                            <ul>
                                ...
                                <p style="font-weight: 600;">Les outils et le matériel de cordonnerie (machines, cuir, produits de finition) restent à la charge de l'apprenant. </p>
