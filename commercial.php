...
<body id="inner_page" data-spy="scroll" data-target="#navbar-wd" data-offset="98">
    ...
    <section class="inner_banner">
        ...
        <div class="container">
            <div class="full animate__animated animate__fadeInDown">
                <h3> Entrepreneuriat Commercial </h3>
            </div>
        </div>
    </section>
    <!--section-->
            ...
            <div class="row">
                <div class="col-md-12">
                    <p style="font-size: 2rem; font-weight: 600;line-height: 1.6; text-align: center">
                        Devenez Entrepreneur Commercial : Maîtrisez les Compétences pour Créer et Gérer une Entreprise
                        Réussie</p>
                </div>
                <div class="col-md-12 text-justify ">
                    <p style="font-size:1rem " ;>Cette formation en entrepreneuriat commercial vise à
                        former des individus dynamiques et créatifs capables de concevoir, lancer, et gérer des
                        entreprises
                        prospères dans le domaine commercial. Elle offre des compétences pratiques et théoriques pour
                        naviguer
                        dans le monde des affaires, développer des stratégies de
                        vente efficaces, et répondre aux besoins des clients tout en atteignant des objectifs
                        financiers.</p>
                </div>
            </div>
        </div>
    ...
    <section style="padding: 50px;">
        ...
        <div class="centered-columns">
            <div>
                <p><i class="fas fa-chevron-right"></i> Concevoir un business plan détaillé et réaliste
                </p>
                <p><i class="fas fa-chevron-right"></i> Identifier les opportunités commerciales grâce à des études de
                    marché approfondies.</p>
                <p><i class="fas fa-chevron-right"></i> Maîtriser les techniques de négociation et de vente.</p>
                <p><i class="fas fa-chevron-right"></i> Comprendre les bases de la gestion financière et comptable.</p>
                <p><i class="fas fa-chevron-right"></i> Développer des stratégies marketing pour promouvoir vos produits
                    et services.
                <p>
            </div>
            <div>
                <p><i class="fas fa-chevron-right"></i> Utiliser les outils numériques pour booster vos ventes et gérer
                    votre entreprise.
                <p>
                <p><i class="fas fa-chevron-right"></i> Créer un réseau de partenaires et de fournisseurs fiables
                </p>
                <p><i class="fas fa-chevron-right"></i> Comprendre les aspects juridiques et administratifs de la
                    création et de la gestion d’entreprise.</p>

                <p><i class="fas fa-chevron-right"></i> Mesurer et analyser les performances de votre entreprise pour
                    ...
                    <div id="collapse1" class="collapse" aria-labelledby="heading1" data-parent="#accordion">
                        <div class="card-body">
                            <ul>
                                ...
                                <li><i class="fas fa-chevron-right"></i>
                                    Consultant en stratégie commerciale</li> <br>

                                <li><i class="fas fa-chevron-right"></i>
                                    Chef d'entreprise
                                </li> <br>
                                <li><i class="fas fa-chevron-right"></i>
                                    Gestionnaire de projet commercial
                                </li> <br>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="card">
                    ...
                    <div id="collapse2" class="collapse" aria-labelledby="heading2" data-parent="#accordion">
                        <div class="card-body">
                            ...
                            <ul>
                                <li><i class="fas fa-chevron-right"></i>
                                    Motivation et capacité à prendre des initiatives.</li> <br>

                                <li><i class="fas fa-chevron-right"></i>
                                    Intérêt pour le commerce et les affaires.
                                </li> <br>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="card">
                    ...
                    <div id="collapse5" class="collapse" aria-labelledby="heading5" data-parent="#accordion">
                        <div class="card-body">
                            ...
                            <ul>
                                <li><i class="fas fa-chevron-right"></i>
                                    <span style="font-weight: 600;">Ateliers pratiques</span> : Participez à des séances en présentiel pour appliquer vos connaissances à des projets réels.
                                </li> <br>
                                <li><i class="fas fa-chevron-right"></i>
                                    <span style="font-weight: 600;">Mentorat personnalisé</span>  : Recevez des conseils d’entrepreneurs expérimentés.
                                </li> <br>
                                ...
                                <li><i class="fas fa-chevron-right"></i>
                                    ...
                                    </span> : Recevez des conseils d’entrepreneurs expérimentés.
                                </li> <br>

                                <li><i class="fas fa-chevron-right"></i>
                                    <span style="font-weight: 600;">
                                        Simulations d’entreprise
                                    </span> : Testez vos compétences en créant et en gérant une entreprise fictive.
                                </li>
                                <br>
                                <li><i class="fas fa-chevron-right"></i>
                                    <span style="font-weight: 600;">
                                        Projets collaboratifs
                                    </span> : Travaillez en groupe pour développer des idées innovantes.
                                </li>
                                <br>
                                ...
                                <li><i class="fas fa-chevron-right"></i>
                                    ...
                                    </span>  : Acquérez une expérience réelle en immersion dans une organisation commercial
                                </li>
                                <br>
                        </div>
                    </div>
