...
Devenez Expert en Couture : Maîtrisez la Conception et la Réalisation de Vêtements de A à Z</p>
                </div>
                <div class="col-md-12 text-justify ">
                    <p style="font-size:1rem " ;>Cette formation intensive vous permettra de devenir un couturier ou une couturière qualifié(e) et polyvalent(e). Vous apprendrez à concevoir et réaliser des vêtements sur mesure, à maîtriser les techniques de couture avancées et à comprendre les principes du design vestimentaire. Grâce à une approche pratique et intensive, vous serez opérationnel(le) et capable de répondre aux besoins du marché de la mode et de la confection.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section style="padding: 50px;">
        ...
        <div class="centered-columns">
            <div>
                <p><i class="fas fa-chevron-right"></i> Réaliser des croquis et des patrons pour des vêtements féminins et masculins.</p>
                <p><i class="fas fa-chevron-right"></i> Utiliser des techniques de couture de base et avancées pour réaliser des pièces de haute qualité.</p>
                <p><i class="fas fa-chevron-right"></i> Appliquer les principes de design vestimentaire, y compris la coupe, la couture et les finitions</p>
                <p><i class="fas fa-chevron-right"></i> Effectuer des ajustements et des réparations sur des vêtements existants.</p>


            </div>
            <div>
            <p><i class="fas fa-chevron-right"></i>     Sélectionner les tissus et les matériaux adaptés à chaque projet.
                <p>
                <p><i class="fas fa-chevron-right"></i>  Créer des prototypes et des échantillons pour tester et valider les designs   <p>
                <p><i class="fas fa-chevron-right"></i>  Comprendre les tendances de la mode et les intégrer dans vos créations.</p>
                <p><i class="fas fa-chevron-right"></i>  Travailler efficacement en atelier, en équipe, et en collaboration avec des stylistes et des designers.
                <p>
                <p><i class="fas fa-chevron-right"></i>  Présenter et défendre vos créations lors de défilés et d'expositions.<p>
            ...
            <div id="accordion">
                    ...
                    <div id="collapse1" class="collapse" aria-labelledby="heading1" data-parent="#accordion">
                        <div class="card-body">
                            ...
                            <ul>
                                ...
                                <li><i class="fas fa-chevron-right"></i>
                                Créateur(trice) de vêtements sur mesure </li> <br>

                                <li><i class="fas fa-chevron-right"></i>
                                Designer textile
                                </li> <br>
                                <li><i class="fas fa-chevron-right"></i>
                                Créateur(trice) de vêtements sur mesure
                                </li> <br>
                                <li><i class="fas fa-chevron-right"></i>
                                Responsable de production en atelier de couture
                                </li> <br>
                ...
                <div class="card">
                    ...
                    <div id="collapse2" class="collapse" aria-labelledby="heading2" data-parent="#accordion">
                        <div class="card-body">
                            ...
                            <ul>
                                <li><i class="fas fa-chevron-right"></i>
                                Une sensibilité esthétique et un intérêt pour la mode et le design.</li> <br>
                ...
                <div class="card">
                    ...
                    <div id="collapse3" class="collapse" aria-labelledby="heading3" data-parent="#accordion">
                        <div class="card-body">
                            ...
                            <ul>
                                <li><i class="fas fa-chevron-right"></i>
                                Des contrôles continus (quiz, exercices pratiques de couture).</li> <br>

                                <li><i class="fas fa-chevron-right"></i>
                                Des projets individuels et en équipe.</li> <br>

                                <li><i class="fas fa-chevron-right"></i>
                                Un projet final qui sera présenté et évalué par un jury composé de professionnels du secteur.</li> <br>
                ...
                <div class="card">
                    ...
                    <div id="collapse4" class="collapse" aria-labelledby="heading4" data-parent="#accordion">
                        <div class="card-body">
                            <p> La formation se déroule sur une durée de <span style="font-weight: 700;"> 12 mois</span>
                ...
                <div class="card">
                    ...
                    <div id="collapse5" class="collapse" aria-labelledby="heading5" data-parent="#accordion">
                        <div class="card-body">
                            ...
                            <ul>
                                <li><i class="fas fa-chevron-right"></i>
                                    <span style="font-weight: 600;">Cours interactifs</span> :Accédez à des modules complets sur notre plateforme e-learning, incluant vidéos, études de cas et exercices pratiques.      </li> <br>

                                <li><i class="fas fa-chevron-right"></i>
                                    <span style="font-weight: 600;">
                                    Ateliers en présentiel
                                    </span> : Participez à des sessions pratiques où vous pourrez affiner vos compétences avec des professionnels et poser des questions sur des projets concrets.</li> <br>

                                <li><i class="fas fa-chevron-right"></i>
                                    <span style="font-weight: 600;">
                                    Mentorat individuel
                                    </span> : Recevez un accompagnement de la part d'un mentor expérimenté, avec des conseils et des retours sur vos créations.</li>
                                <br>
                                <li><i class="fas fa-chevron-right"></i>
                                    <span style="font-weight: 600;">
                                ...
                                <li><i class="fas fa-chevron-right"></i>
                                    <span style="font-weight: 600;">
                                    Challenges et concours de tissage  
                                    </span>: Participez à des concours pour tester vos compétences et enrichir votre portfolio.</li>
                                <br>
                                <li><i class="fas fa-chevron-right"></i>
                                    <span style="font-weight: 600;">
                                    Projet professionnel 
                                    </span>  : Appliquez vos connaissances en entreprise, en collaborant sur des projets réels.</li>
                                <br>
                                <li><i class="fas fa-chevron-right"></i>
                                    <span style="font-weight: 600;">
                                    Mini-soutenances régulières  
                                    </span>  : Recevez des retours sur vos progrès pour vous améliorer de façon continue</li>
                                <br>
