...
<body id="inner_page" data-spy="scroll" data-target="#navbar-wd" data-offset="98">
            ...
            <div class="row">
                <div class="col-md-12">
                    <p style="font-size: 2rem; font-weight: 600;line-height: 1.6; text-align: center">
                        Devenez Artisan Maroquinier : Maîtrisez l'Art de la Création et de la Restauration d'Articles en
                        Cuir</p>
                </div>
                <div class="col-md-12 text-justify ">
                    <p style="font-size:1rem " ;>Cette formation intensive vous permettra d'acquérir les compétences
                        nécessaires pour concevoir, fabriquer et restaurer des articles de maroquinerie tels que sacs,
                        portefeuilles, ceintures, et autres accessoires en cuir. Vous apprendrez les techniques
                        artisanales et modernes pour produire des pièces élégantes et durables tout en développant un
                        style unique.</p>
                </div>
            </div>
        </div>
    ...
    <section style="padding: 50px;">
        ...
        <div class="centered-columns">
            <div>
                <p><i class="fas fa-chevron-right"></i> Concevoir des modèles d'articles en cuir en créant des patrons
                    précis</p>
                <p><i class="fas fa-chevron-right"></i> Sélectionner et préparer les cuirs et matériaux adaptés à chaque
                    projet.</p>
                <p><i class="fas fa-chevron-right"></i> Réaliser des techniques de découpe, d’assemblage, de couture à
                    la main et à la machine.</p>
                <p><i class="fas fa-chevron-right"></i> Fabriquer des articles variés comme sacs, portefeuilles,
                    ceintures, étuis, et accessoires</p>


            </div>
            <div>
                <p><i class="fas fa-chevron-right"></i> Maîtriser les techniques de finition : peinture des bords,
                    teinture, polissage et pose d’ornements.
                <p>
                <p><i class="fas fa-chevron-right"></i> Restaurer et personnaliser des articles existants en cuir.
                <p>
                <p><i class="fas fa-chevron-right"></i> Utiliser des outils et machines spécifiques à la maroquinerie
                </p>
                <p><i class="fas fa-chevron-right"></i> Créer des collections cohérentes et organiser la production en
                    petite série.</p>
                <p><i class="fas fa-chevron-right"></i> Comprendre les bases de la gestion d'un atelier et de la
                    commercialisation de produits artisanaux.</p>
                        ...
                        <div class="card-body">
                            <ul>
                                ...
                                <li><i class="fas fa-chevron-right"></i>
                                    ...
                                    Créateur d’articles en cuir
                                </li> <br>

                                <li><i class="fas fa-chevron-right"></i>
                                    Restaurateur d’articles en cuir</li> <br>

                                <li><i class="fas fa-chevron-right"></i>
                                    Technicien en maroquinerie
                                </li> <br>
                                <li><i class="fas fa-chevron-right"></i>
                                    Responsable de production en maroquinerie
                                </li> <br>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="card">
                    ...
                    <div id="collapse2" class="collapse" aria-labelledby="heading2" data-parent="#accordion">
                        <div class="card-body">
                            ...
                            <ul>
                                <li><i class="fas fa-chevron-right"></i>
                                    Intérêt pour le travail manuel et le design artisanal</li> <br>

                                <li><i class="fas fa-chevron-right"></i>
                                    Sens de la précision et de la créativité
                                </li> <br>
                                <li><i class="fas fa-chevron-right"></i>
                                    Motivation et capacité d’apprentissage
                                </li> <br>
                                <li><i class="fas fa-chevron-right"></i>
                                    Connaissance de base en dessin ou en couture (facultatif)
                                </li> <br>
                    ...
                    <div id="collapse3" class="collapse" aria-labelledby="heading3" data-parent="#accordion">
                        <div class="card-body">
                            ...
                            <ul>
                                ...
                                <li><i class="fas fa-chevron-right"></i>
                                    Projet final présenté devant un jury composé de professionnels</li> <br>
                        ...
                        <div class="card-body">
                            ...
                            <ul>
                                ...
                                <li><i class="fas fa-chevron-right"></i>
                                    ...
                                    </span> :Perfectionnez vos compétences dans des ateliers équipés de matériel professionnel.
                                </li> <br>
                                ...
                                <li><i class="fas fa-chevron-right"></i>
                                    ...
                                    </span> : Participez à des projets en groupe pour développer votre créativité et votre esprit d'équipe.
                                </li>
                                <br>
                                <li><i class="fas fa-chevron-right"></i>
                                    <span style="font-weight: 600;">
                                        Challenges et expositions
                                    </span>: Montrez vos créations lors d’événements ou d’expositions.
                                </li>
                                <br>
                                <li><i class="fas fa-chevron-right"></i>
                                    <span style="font-weight: 600;">
                                        Stage professionnel
                                    </span> :Appliquez vos compétences dans un atelier ou une entreprise de maroquinerie.
                                </li>
                                <br>
                        </div>
                    </div>
                    ...
                    <div id="collapse7" class="collapse" aria-labelledby="heading7" data-parent="#accordion">
                        <div class="card-body">
                            ...
                            <ul>
                                ...
                                <p style="font-weight: 600;">Les outils et matériaux spécifiques (machines, cuir, accessoires) sont à la charge des apprenants. </p>
