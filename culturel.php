...
<body id="inner_page" data-spy="scroll" data-target="#navbar-wd" data-offset="98">
    ...
    <section class="inner_banner">
        ...
        <div class="container">
            <div class="full animate__animated animate__fadeInDown">
                <h3> Entrepreunariat Culturel Artistique et Touristique </h3>
            </div>
        </div>
    </section>
    <!--section-->
        ...
        <div class="container" style="padding-top: 60px;">
            <div class="row">
                <div class="col-md-12">
                    ...
                    Devenez Entrepreneur dans les Secteurs Culturel, Artistique et Touristique : Formez-vous pour Réussir</p>
                </div>
                <div class="col-md-12 text-justify ">
                    <p style="font-size:1rem " ;>Cette formation spécialisée en entrepreneuriat culturel, 
                        artistique et touristique vous prépare à créer et gérer des projets innovants dans des domaines riches 
                        en opportunités. Vous apprendrez à valoriser les patrimoines 
                        culturels, promouvoir les œuvres artistiques et développer des activités touristiques attractives.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section style="padding: 50px;">
        ...
        <div class="centered-columns">
            <div>
                <p><i class="fas fa-chevron-right"></i> Concevoir des projets culturels, artistiques ou touristiques innovants.</p>
                <p><i class="fas fa-chevron-right"></i> Analyser les besoins du marché et définir des stratégies adaptées. </p>
                <p><i class="fas fa-chevron-right"></i> Maîtriser les outils numériques pour la promotion et la gestion de vos projets.</p>
                <p><i class="fas fa-chevron-right"></i> Gérer les aspects juridiques et administratifs liés aux secteurs culturel, artistique et touristique.</p>


            </div>
            <div>
                <p><i class="fas fa-chevron-right"></i> Élaborer des plans de communication et marketing spécifiques à ces domaines.
                <p>
                <p><i class="fas fa-chevron-right"></i> Organiser des événements culturels, des expositions artistiques ou des circuits touristiques.
                <p>
                <p><i class="fas fa-chevron-right"></i> Mesurer et évaluer les impacts économiques et sociaux de vos projets.
                </p>
            </div>
        </div>
    </section>
    ...
    <section style="padding: 50px;">
        ...
        <div>
            ...
            <ul>
                ...
                <li class="list-item"><i class="fa fa-check-circle li-icon"></i> Relation presse et partenariats stratégiques.</li>
            ...
            <ul>
                ...
                <li class="list-item"><i class="fa fa-check-circle li-icon"></i>    Gestion des ressources humaines.</li>
            </ul>
        </div>
        ...
        <div>
            <p class="module-title"><i class="fas fa-chevron-right"></i><span style="font-weight: 600">Module 5</span> :Légal et administratif (50h)</p>
                <ul>
                    ...
                    <li class="list-item"><i class="fa fa-check-circle li-icon"></i>    Création et gestion administrative d’entreprise</li>
                </ul>
            </p>
            ...
            <ul>
                ...
                <li class="list-item"><i class="fa fa-check-circle li-icon"></i> Création de parcours touristiques ou de festivals.</li>
                    ...
                    <div id="collapse1" class="collapse" aria-labelledby="heading1" data-parent="#accordion">
                        <div class="card-body">
                            ...
                            <ul>
                                ...
                                <li><i class="fas fa-chevron-right"></i>
                                Organisateur d’événements culturels.</li> <br>

                                <li><i class="fas fa-chevron-right"></i>
                                Gestionnaire de sites touristiques.
                                </li> <br>
                                <li><i class="fas fa-chevron-right"></i>
                                Consultant en valorisation du patrimoine.
                                </li> <br>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="card">
                    ...
                    <div id="collapse2" class="collapse" aria-labelledby="heading2" data-parent="#accordion">
                        <div class="card-body">
                            ...
                            <ul>
                                <li><i class="fas fa-chevron-right"></i>
                                Intérêt marqué pour les secteurs culturel, artistique ou touristique.</li> <br>

                                <li><i class="fas fa-chevron-right"></i>
                                Créativité et esprit entrepreneurial.
                                </li> <br>
                                <li><i class="fas fa-chevron-right"></i>
                        ...
                        <div class="card-body">
                            ...
                            <ul>
                                ...
                                <li><i class="fas fa-chevron-right"></i>
                                    <span style="font-weight: 600;">
                                    Stages
                                    </span> : Immersion dans des entreprises culturelles ou touristiques.
                                </li>
                                <br>
                                <li><i class="fas fa-chevron-right"></i>
                                    <span style="font-weight: 600;">
