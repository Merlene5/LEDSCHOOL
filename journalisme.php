...
<body id="inner_page" data-spy="scroll" data-target="#navbar-wd" data-offset="98">
        ...
        <div class="container" style="padding-top: 60px;">
            <div class="row">
                <div class="col-md-12">
                    ...
                    Formation Web Journalisme : Maîtrisez l'art du journalisme numérique</p>
                </div>
                <div class="col-md-12 text-justify ">
                    <p style="font-size:1rem " ;>Cette formation vous prépare à exercer le métier de journaliste dans un environnement numérique en constante évolution. Vous apprendrez à créer du contenu percutant pour le web, maîtriser les outils numériques et les techniques de storytelling multimédia. Grâce à une approche pratique et innovante, vous serez prêt à relever les défis du journalisme en ligne et à répondre aux attentes des lecteurs modernes.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section style="padding: 50px;">
        ...
        <div class="centered-columns">
            <div>
                <p><i class="fas fa-chevron-right"></i> Rédiger et publier des articles optimisés pour le web (SEO).</p>
                <p><i class="fas fa-chevron-right"></i> Maîtriser les outils et logiciels de création de contenu multimédia (vidéo, audio, infographie).</p>
                <p><i class="fas fa-chevron-right"></i> Animer des plateformes numériques : sites web, blogs, réseaux sociaux.</p>
                <p><i class="fas fa-chevron-right"></i> Réaliser des enquêtes et reportages adaptés au web.</p>
            </div>
            <div>


                <p><i class="fas fa-chevron-right"></i> Concevoir et mettre en œuvre une stratégie éditoriale en ligne.
                <p>
                <p><i class="fas fa-chevron-right"></i> Utiliser les réseaux sociaux pour diffuser et promouvoir du contenu journalistique.
                <p>
                <p><i class="fas fa-chevron-right"></i> Respecter l’éthique journalistique dans un environnement numérique
                <p>
                <p><i class="fas fa-chevron-right"></i> Mesurer l’impact et la portée des contenus grâce aux outils d’analyse.<p>
        ...
        <div class="columns">
            ...
            <div>
                ...
                <ul>
                    ...
                    <li class="list-item"><i class="fa fa-check-circle li-icon"></i> Gestion des plagiats et des droits d’auteur</li>
            ...
            <ul>
                ...
                <li class="list-item"><i class="fa fa-check-circle li-icon"></i> Utilisation d’outils numériques pour les recherches et vérifications </li>
                    ...
                    <div id="collapse1" class="collapse" aria-labelledby="heading1" data-parent="#accordion">
                        <div class="card-body">
                            ...
                            <ul>
                                ...
                                <li><i class="fas fa-chevron-right"></i>
                               Correspondant numérique </li> <br>
                                
                               <li><i class="fas fa-chevron-right"></i>
                               Réalisateur de podcasts ou de reportages web </li> <br>
                               <li><i class="fas fa-chevron-right"></i>
                               Responsable éditorial digital </li> <br>
                ...
                <div class="card">
                    ...
                    <div id="collapse2" class="collapse" aria-labelledby="heading2" data-parent="#accordion">
                        <div class="card-body">
                            <ul>
                                <li><i class="fas fa-chevron-right"></i>
                                Maîtrise de base des outils informatiques</li> <br>

                                <li><i class="fas fa-chevron-right"></i>
                                Bonne expression écrite et orale</li> <br>

                                <li><i class="fas fa-chevron-right"></i>
                                Intérêt pour les médias et l’actualité.</li> <br>
                                    <li><i class="fas fa-chevron-right"></i>
                                    Sens de l’analyse et curiosité intellectuelle </li> <br>
                ...
                <div class="card">
                    ...
                    <div id="collapse5" class="collapse" aria-labelledby="heading5" data-parent="#accordion">
                        <div class="card-body">
                            ...
                            <ul>
                                <li><i class="fas fa-chevron-right"></i>
                                    <span style="font-weight: 600;">Cours interactifs et ateliers pratiques</span> :Maîtrisez les bases du journalisme web avec des sessions enrichies par des exercices pratiques.
                                </li> <br>

                                <li><i class="fas fa-chevron-right"></i>
                                    <span style="font-weight: 600;">
                                        Mentorat personnalisé
                                    </span> : Recevez des conseils et un suivi individualisé pour développer votre style journalistique.
                                </li> <br>

                                <li><i class="fas fa-chevron-right"></i>
                                    <span style="font-weight: 600;">
                                    Travail collaboratif
                                    </span> : Collaborez sur des projets journalistiques en ligne, depuis la conception jusqu’à la publication. </li>
                                <br>
                                ...
                                <li><i class="fas fa-chevron-right"></i>
                                    <span style="font-weight: 600;">
                                    Réalisation de projets réels :
                                    </span> Publiez des articles et reportages sur des plateformes en ligne pour une mise en pratique directe.
                                </li>
                                <br>
                                <li><i class="fas fa-chevron-right"></i>
                                    <span style="font-weight: 600;">
                                    Soutenances et retours d’experts 
                                    </span> Présentez vos projets devant des professionnels du journalisme pour affiner vos compétences.                                </li>
                                <br>
                            </ul>
