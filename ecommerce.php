...
<body id="inner_page" data-spy="scroll" data-target="#navbar-wd" data-offset="98">
            ...
            <div class="row">
                <div class="col-md-12">
                    <p style="font-size: 2rem; font-weight: 600;line-height: 1.6; text-align: center">
                        Devenez E-commerçant :Créez et gérez des projets innovants en E-commerce </p>
                </div>
                <div class="col-md-12 text-justify ">
                    <p style="font-size:1rem " ;>Led School vous propose une formation pour découvrir les bases de la vente en ligne et apprendre à créer un site E-Commerce  afin de créer une boutique de commerce électronique personnalisée qui soit rapidement rentable.Très 
                        pratique et concrète,vous apprendrez à pour bien paramétrer votre boutique en ligne,
                         à créer des produits et des collections, pour trouver des marchés intéressants et à identifier vos clients et les amener sur votre magasin pour qu’ils achètent vos produits. Vous apprendrez également à analyser vos ventes pour mettre en place une stratégie commerciale efficace.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section style="padding: 50px;">
        ...
        <div class="centered-columns">
            <div>
                <p><i class="fas fa-chevron-right"></i> Comprendre les principes fondamentaux de l'E-commerce</p>
                <p><i class="fas fa-chevron-right"></i> Développer des compétences en gestion et en management de boutique en ligne </p>
                <p><i class="fas fa-chevron-right"></i> Apprendre à valoriser les produits et services, promouvoir les ventes en ligne et développer des stratégies de marketing et de vente efficaces</p>
              

            </div>
            <div>
                <p><i class="fas fa-chevron-right"></i> Maîtriser les techniques de création et de gestion de site web de commerce en ligne</p>

                <p><i class="fas fa-chevron-right"></i> Comprendre les enjeux de la sécurité et de la confidentialité des données dans l'E-commerce                </p>
            </div>
        </div>
    </section>
    ...
    <section style="padding: 50px;">
        ...
        <div class="columns">
            <!-- Column 1 -->
        <div>
            <p class="module-title"><i class="fas fa-chevron-right"></i><span style="font-weight: 600">Module 1</span>:  Introduction à l'E-commerce (100h)</p>
            <p class="module-title"><i class="fas fa-chevron-right"></i><span style="font-weight: 600">Module 2</span> : Gestion et management de boutique en ligne(150h)</p>
          
              
            <p class="module-title"><i class="fas fa-chevron-right"></i><span style="font-weight: 600">Module 3</span> :  Valorisation des produits et services(50h)</p>
            <p class="module-title"><i class="fas fa-chevron-right"></i><span style="font-weight: 600">Module 4</span> : Promotion des ventes en ligne(50h)</p>
        ...
        <div>
            ...
            <p class="module-title"><i class="fas fa-chevron-right"></i><span style="font-weight: 600">Module 5</span> : Stratégies de marketing et de vente efficaces(100h)</p>
                
            </p>
            <p class="module-title"><i class="fas fa-chevron-right"></i><span style="font-weight: 600">Module 6</span> : Création et gestion de site web de commerce en ligne (50h)</p>
                
        </p>
        <p class="module-title"><i class="fas fa-chevron-right"></i><span style="font-weight: 600">Module 7</span> :     Sécurité et confidentialité des données dans  <br>l'E-commerce(50h)</p>
                    ...
                    <div id="collapse1" class="collapse" aria-labelledby="heading1" data-parent="#accordion">
                        <div class="card-body">
                            ...
                            <ul>
                                ...
                                <li><i class="fas fa-chevron-right"></i>
                                    Responsable de marketing et de vente en ligne</li> <br>
                            </ul>
                        </div>
                    </div>
                </div>
                <div class="card">
                    ...
                    <div id="collapse2" class="collapse" aria-labelledby="heading2" data-parent="#accordion">
                        <div class="card-body">
                            ...
                            <ul>
                                <li><i class="fas fa-chevron-right"></i>
                                    Maîtrise de l'outil informatique</li> <br>

                                <li><i class="fas fa-chevron-right"></i>
                                    Intérêt pour l'E-commerce et la gestion de boutique en ligne
                                </li> <br>
                                <li><i class="fas fa-chevron-right"></i>
                            ...
                            Une première expérience en agro business serait un plus, mais n'est pas obligatoire
                                </li> <br>
