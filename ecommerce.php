...
<body id="inner_page" data-spy="scroll" data-target="#navbar-wd" data-offset="98">
    ...
    <section style="padding: 50px;">
        ...
        <div class="columns">
            <!-- Column 1 -->
        <div>
            <p class="module-title"><i class="fas fa-chevron-right"></i><span style="font-weight: 600">Module 1</span>:  Introduction à l'E-commerce </p>
            <p class="module-title"><i class="fas fa-chevron-right"></i><span style="font-weight: 600">Module 2</span> : Gestion et management de boutique en ligne</p>
          
              
            <p class="module-title"><i class="fas fa-chevron-right"></i><span style="font-weight: 600">Module 3</span> :  Valorisation des produits et services</p>
            <p class="module-title"><i class="fas fa-chevron-right"></i><span style="font-weight: 600">Module 4</span> : Promotion des ventes en ligne</p>
        ...
        <div>
            ...
            <p class="module-title"><i class="fas fa-chevron-right"></i><span style="font-weight: 600">Module 5</span> : Stratégies de marketing et de vente efficaces</p>
                
            </p>
            <p class="module-title"><i class="fas fa-chevron-right"></i><span style="font-weight: 600">Module 6</span> : Création et gestion de site web de commerce en ligne</p>
                
        </p>
        <p class="module-title"><i class="fas fa-chevron-right"></i><span style="font-weight: 600">Module 7</span> :     Sécurité et confidentialité des données dans  <br>l'E-commerce</p>
