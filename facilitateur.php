...
<body id="inner_page" data-spy="scroll" data-target="#navbar-wd" data-offset="98">
    ...
    <section class="inner_banner">
        ...
        <div class="container">
            <div class="full animate__animated animate__fadeInDown">
                <h3>Facilitateur Communautaire</h3>
            </div>
        </div>
    </section>
    <!--section-->
    ...
    <section style="padding: 50px;">
        ...
        <div class="columns">
            <!-- Column 1 -->
        <div>
            <p class="module-title"><i class="fas fa-chevron-right"></i><span style="font-weight: 600">Module 1</span>: Introduction à la facilitation communautaire </p>
            <p class="module-title"><i class="fas fa-chevron-right"></i><span style="font-weight: 600">Module 2</span> : Communication et animation participative </p>
          
              
            <p class="module-title"><i class="fas fa-chevron-right"></i><span style="font-weight: 600">Module 3</span> : Diagnostic participatif</p>
            <p class="module-title"><i class="fas fa-chevron-right"></i><span style="font-weight: 600">Module 4</span> : Mobilisation communautaire et leadership </p>
        ...
        <p class="module-title"><i class="fas fa-chevron-right"></i><span style="font-weight: 600">Module 5</span> :Gestion de projets communautaires </p>
                
         </p>  
         <p class="module-title"><i class="fas fa-chevron-right"></i><span style="font-weight: 600">Module 6</span> :  Collaboration avec les partenaires et institutions </p>
                
        </p>
        <p class="module-title"><i class="fas fa-chevron-right"></i><span style="font-weight: 600">Module 7</span> :  Outils numériques pour les facilitateurs </p>
